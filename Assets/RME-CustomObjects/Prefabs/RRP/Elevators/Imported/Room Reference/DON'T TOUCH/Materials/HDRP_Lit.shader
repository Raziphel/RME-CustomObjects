Shader "HDRP/Lit" {
	Properties {
		...
		[Enum(UnityEngine.Rendering.CullMode)] _TransparentCullMode ("_TransparentCullMode", Float) = 2
		[Enum(UnityEngine.Rendering.CullMode)] _OpaqueCullMode ("_OpaqueCullMode", Float) = 2
